 ...
 */
declare type VisitorHistoryFilter = paths['/visitors/{visitor_id}']['get']['parameters']['query'];
/**
...
declare type VisitorsError403 = paths['/visitors/{visitor_id}']['get']['responses']['403']['content']['application/json'] & {
    status: 403;
};
declare type VisitorsError429 = paths['/visitors/{visitor_id}']['get']['responses']['429']['content']['application/json'] & {
    status: 429;
    retryAfter: number;
};
declare type VisitorsError = VisitorsError403 | VisitorsError429;
...
declare type EventError403 = paths['/events/{request_id}']['get']['responses']['403']['content']['application/json'];
declare type EventError404 = paths['/events/{request_id}']['get']['responses']['404']['content']['application/json'];
declare type GenericEventError = EventError403 | EventError404;
declare type EventErrorCode<T extends GenericEventError> = T extends EventError403 ? 403 : 404;
declare type EventError<T extends GenericEventError = GenericEventError> = T & {
 ...
 */
declare type VisitWebhook = components['schemas']['WebhookVisit'];
        ...
        products?: {
            ...
            ipBlocklist?: {
                data?: {
                    result?: boolean | undefined;
                    details?: {
                        emailSpam?: boolean | undefined;
                        attackSource?: boolean | undefined;
                    } | undefined;
                } | undefined;
                error?: {
                    code: "Failed" | "TooManyRequests";
            ...
            vpn?: {
                data?: {
                    result?: boolean | undefined;
                    methods?: {
                        timezoneMismatch?: boolean | undefined;
                        publicVPN?: boolean | undefined;
                    } | undefined;
                } | undefined;
                error?: {
                    code: "Failed" | "TooManyRequests";
...
export { AuthenticationMode, EventError, EventError403, EventError404, EventResponse, FingerprintJsServerApiClient, Options, Region, VisitWebhook, VisitorHistoryFilter, VisitorsError, VisitorsError403, VisitorsError429, VisitorsResponse, getEventUrl, getVisitorsUrl, isEventError, isVisitorsError };
